...
//const socatParams = settings.serial.port.value+',raw,b'+settings.serial.baud.value+',echo=0';
//console.log('socat' + socatParams);
//const serial = require('child_process').spawn('socat', ['-', socatParams]);

var net = require('net')
var serial = net.createConnection({ path: '/tmp/socket_test.s' });
